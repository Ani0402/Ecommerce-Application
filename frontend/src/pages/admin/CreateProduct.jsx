...
const CreateProduct = () => {
  ...
  const handleCreate=async()=>{
     try{
        ...
        const {data}=await axios.post(`${REACT_APP_API}/api/v1/product/create-product`,productData)
          ...
          <div className="col-md-9">
            ...
            <div className="m-1 w-75">
              ...
              <div className="mb-3">
                {
                  photo && (
                    // src={URL.createObjectURL(photo)}: This attribute  specifies the source of the image. In this case, it's using the URL.createObjectURL() method provided by the browser's URL object. The createObjectURL() method creates a temporary URL representing the photo object (likely a File object). This temporary URL is used to display the image in the browser.
                    <div className="text-center">
                      <img src={URL.createObjectURL(photo)} alt="prod_photo" height={'200px'} className="img img-responsive" />
                    </div>
                  )
                }
              </div>
